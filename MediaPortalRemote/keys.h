...
const int previouspageT = 0;
//pgdown is next page
const int nextpageR = 0;
const int nextpageT = 0;
//M is mute
const int muteR = 0;
const int muteT = 0;
//P is play all
...
const int playpreviousT = 0;
//F8 is Play next
const int playnextR = 0;
const int playnextT = 0;
...
const int osdshowT = 0;
//F1 reset to default
const int defaultR = 0;
const int defaultT = 0;
